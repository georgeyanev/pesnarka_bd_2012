...
\score{
  ...
  \new Voice \absolute  {
    ...
    \time 4/4  a'2^ \p c''4 bes'4 | a'4 ( g'4 ) a'2 ( | a'4 ) r4 r4 a4^\mf ^\< | f'2 e'4 \autoBeamOn d'8 \! ( e'32^\sosten d'32 cis'32 d'32 ) | \break

    bes'2^\atempo^\> a'2 ( | a'4 \! ) r4 r4 \times 2/3  { e'8^\< ( f'8 g'8 ) } | a'4 \! \fermata g'4^\> f'4 e'4 |   d'2 \! r2 | \break

    a4^\mf  \autoBeamOff   d'8 e'8 \autoBeamOn f'8 ( d'8 )  cis'8 ( d'8 ) | e'8 a8 bes4 ( a8 g8 ) a4 ( | a4 ) r4 r2 | \break
    ...
    bes'2 a'4 ( | a'4 ) a4 a4 | e'2 d'4 ( | d'4 ) r4 a4 | d'2^\p^\< \autoBeamOff e'8. e'16 \! | \break

    \autoBeamOn f'4^\> ( d'4 cis'8 d'8 | \time 4/4  e'4 ) a4 \! a'2^"," ^\> | c''4^\rall. bes'4 a'4^\ppp ( g'4 ) | a'1 |
