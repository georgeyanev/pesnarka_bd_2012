...
\bookpart {
  ...
  \score{
    ...
    \new Voice \absolute {
      ...
      \time 2/4 d''4  cis''8 \noBeam cis'' | d''2  | f'4 e'8 e' | d'4. \bar "!" \bar "!" d'16 ( e' ) \break |
      ...
      \time 6/8  \repeat volta 2 {
        ...
        e'4 g'8 f'4 e'8 | f'4 e'8 d'4. | \time 2/4 \tempo 4=60  d''4 cis''8 \noBeam cis'' \break |

        d''2 | f'4 e'8 \noBeam e' |
      } \alternative { { d'4. \bar "!" \bar "!" d'16 ( e'16 ) } { d'2 } } \break |
