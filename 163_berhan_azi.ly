...
\bookpart {
  ...
  \score {
    ...
    \new Voice \relative c' {
      ...
      ^\markup { \large \italic "poco a poco accelerando"} \tuplet 6/4 { gis,16([a gis f e dis]) } \tuplet 6/4 { gis([a gis f e dis]) } \tuplet 6/4 { gis([a gis f e dis]) } \tempo "rit." \tuplet 6/4 { gis([a gis f e dis]) } | \noBreak
      \time 4/4 \acciaccatura { dis8 } e2 \acciaccatura { dis'8 } e2 | \noBreak
      ^\markup { \large \italic "a tempo"} a,,8_\markup { risoluto } ([b]) c[dis] c4(b) \time 5/4 \break

      \acciaccatura { a8 } fis'4.\fermata( \tuplet 3/2 { e16[fis e]) } dis8[c] b2 | \noBreak
       ^\markup { \large \italic "poco a poco accelerando"} c16([dis c b]) c([dis c b]) c([dis c b]) \tempo "rit." b8.(a16) a4 | \time 4/4 \break

      \repeat volta 1 {
        ^\markup { \large \italic "a tempo"} e''16[f gis a] b8 d,4. \acciaccatura { c16[d] } c4 | \noBreak
        \time 2/4 b2 | \noBreak
      ...
      \repeat volta 1 {
        \time 3/4 ^\markup { \large \italic "poco a poco accelerando"}  \tuplet 3/2 { a8([f e] } \tuplet 3/2 { a[f e] } \tuplet 3/2 { a[f e]) } | \noBreak
        d4 d2 \noBreak
