...
\score{
 ...
 \new Voice \absolute  {
  ...
  \repeat volta 2 { g8 b d'4 | g8 b d'4 | g'4 g' | g'2 |   \break
  
  g'8 a'8 b'4 |  g'8 a'8 b'4 | d''4 d''4 | d''2 | \break
  
  d''8 c'' b'2 | d''8 c'' b'2 | b'8 b'8 a'8 a'8 | g'2 } \break
  
   \time 3/4 g'2 a'4 | b'2. | c''2 b'4 | a'2. | a'2 b'4 | \break
...
\addlyrics {Све -- тъл ден, све  -- тъл ден,
ден, ден, ден.
