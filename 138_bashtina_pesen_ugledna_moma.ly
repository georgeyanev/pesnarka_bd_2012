...
\bookpart {
  ...
  \score {
    ...
    \addlyrics {
      ...
      Тя е ра -- но -- буд -- ни -- ца, ра -- но __ ста -- ва
    ...
    \addlyrics {
      ...
      hu -- ba -- va mo -- ma __ na sve -- tăl den se po --
      zna -- va, __ ko -- ga Slăn -- ce sut -- rin iz -- grja -- va.
      Tja e ra -- no -- bud -- ni -- ca, ra -- no __ sta -- va
