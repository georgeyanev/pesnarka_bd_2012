...
\bookpart {
  ...
  \score{
    ...
    \new Voice \absolute {
      ...
      f'4 f'8 |f'4  f'8 | f'4. ~ |  f'4. \key des \major \time 2/4 | \tempo "Andante" 4=60 bes'4. a'8 | \break
      ...
      } bes4   c'4 \mark \markup{ \bold "rit"} des'4 c'4 | bes2. \mark \markup{ \bold  "D.C. al Fine" } r4
    }
