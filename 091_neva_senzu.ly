  ...
  \layout { 
   ...
   \new Voice \absolute {
    ...
    \cadenzaOn % allows custom bar lines
	 ...
	 \time 7/4 g''4-- g''-- (  f''8 e'' d''8  cis''8 d'' e''8  )  d''2 \bar "|" f''8. f''16 f''4-- e''8-- d'' { cis''8 ( d'' e''8 ) } d''2 \bar "|" \break 

	e''16-- f''16-- g''16-- bes''2-- a''8-- g''8--  f''8 ( e''8 d''8 cis''8 d''8 e''8 ) d''2-- \bar "|" \break 
	
	f''8-- f''-- e''-- d''-- cis''4-- bes'8-- a'8-- g'8-- a'bes'-- a'2-- \fermata  g16-- a-- bes--  a-- \bar "|" \break 
	
	c'2-- bes8 a8 \tuplet 3/2 {g ( a bes-. ) } a2 r8 \tempo "rit. e morendo" g16 a bes  a \bar "|" \break 
	
	c'2-- bes8 \tuplet 3/2 {a8 ( g a-. )  a2.} \bar "|" \break 
