...
\bookpart {
  ...
  \markup \override #'(baseline-skip . 2.5)
    \column  \fontsize  #+2.5 {
      \fill-with-pattern #1 #RIGHT . "А бре, синко – A bre, sinko" \page-ref #'ref137 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Аз съм бялото кокиче –  Аz sam byaloto kokiche" \page-ref #'ref047 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Благославяй – Blagoslavyay" \page-ref #'ref024 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Време е да вървим – Vreme e da varvim" \page-ref #'ref042 "000" "?"
  ...
  \markup \override #'(baseline-skip . 2.5) 
    \column \fontsize  #+2.5 { 
      ...
      \fill-with-pattern #1 #RIGHT . "Дишай дълбоко – Dishay dalboko" \page-ref #'ref063 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Дързост в Христа – Darzost v Hrista" \page-ref #'ref052 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "За Небесния цар – Za Nebesniya tsar" \page-ref #'ref041 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Зора на Новия живот – Zora na Novia zhivot" \page-ref #'ref215 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Зора на Новия живот – Zora na Novia zhivot" \page-ref #'ref016 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Изгрей ти, мое Слънце – Izgrey ti, moe Slantse" \page-ref #'ref030 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Изгрява вече ден тържествен – Izgryava veche den tarzhestven" \page-ref #'ref022 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Изгрява слънцето – Izgryava slantzeto" \page-ref #'ref071_1 "000" "?"
  ...
  \markup \override #'(baseline-skip . 2.5)
    \column \fontsize  #+2.5 { 
      \fill-with-pattern #1 #RIGHT . "Към Рила – Kam Rila" \page-ref #'ref056_2 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Към Сион – Kam Sion" \page-ref #'ref054 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Любовта е извор – Lyubovta e izvor" \page-ref #'ref026 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Милосърдието – Milosardieto" \page-ref #'ref038 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "На белия цвят – Na beliya zvjat" \page-ref #'ref058 "000" "?"
      \fill-with-pattern #1 #RIGHT . "На Учителя – Na Uchitelya" \page-ref #'ref037 "000" "?"
      \fill-with-pattern #1 #RIGHT . "На Христа запейте – Na Hrista zapeyte" \page-ref #'ref060 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Напред да ходим – Napred da hodim" \page-ref #'ref036 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Напред, чада, напред – Napred, chada, napred" \page-ref #'ref048 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Не ли думах – Ne li dumah" \page-ref #'ref164 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Небето се отваря – Nebeto se otvarya" \page-ref #'ref050 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "О, Учителю благати – O, Uchitelyu blagati" \page-ref #'ref051 "000" "?"
  ...
  \markup \override #'(baseline-skip . 2.5)
    \column \fontsize  #+2.5 { 
      ...
      \fill-with-pattern #1 #RIGHT . "Поздрав на Учителя – Pozdrav na Uchitelya" \page-ref #'ref044 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Сила жива, изворна – Sila ziva, izvorna" \page-ref #'ref071_2 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Сине мой, пази живота – Sine moi, pazi zhivota" \page-ref #'ref045 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Слава Божия – Slava Bozhia" \page-ref #'ref053 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Славейчета горски – Slaveycheta gorski" \page-ref #'ref049 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Слънцето на Любовта – Slantseto na Lyubovta" \page-ref #'ref055_1 "000" "?"
  ...
  \markup \override #'(baseline-skip . 2.5)
    \column \fontsize  #+2.5 { 
      ...
      \fill-with-pattern #1 #RIGHT . "Събуди се братко мили – Sabudi se bratko mili" \page-ref #'ref025 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Сърдечен зов – Sardechen zov" \page-ref #'ref039 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Тайната вечеря – Taynata vecherya" \page-ref #'ref066_1 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Ти си проявената Любов – Ti si proyavenata Lyubov" \page-ref #'ref055_2 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Фир-фюр-фен – Fir-fyer-fen" \page-ref #'ref070 "000" "?"
      ...
      \fill-with-pattern #1 #RIGHT . "Шуми – Shumi" \page-ref #'ref032 "000" "?"
      \fill-with-pattern #1 #RIGHT . "Ще се развеселя – Shte se razveselya" \page-ref #'ref021 "000" "?"
