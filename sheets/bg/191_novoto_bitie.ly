...
\bookpart {
  ...
  \markup \center-column \normal-text \fontsize #6.5 {
    \center-align
    \line { \with-link #'ref_desc_17 "     Новото Битие – Създаването на новия Адам" }
    \center-align
  ...
  \score {
    ...
    \addlyrics {
      ...
      \header {
        title = \titleFunc #'ref_desc_17 "Първи Божествен ден" "Părvi Božestven den"
      }
    ...
    \score {
      ...
      \addlyrics {
        ...
        \header {
          title = \titleFunc #'ref_desc_17 "Втори Божествен ден" "Vtori Božestven den"
        }
      ...
      \score {
        ...
        \addlyrics {
          ...
          \header {
            title = \titleFunc #'ref_desc_17 "Трети Божествен ден" "Treti Božestven den"
          }
        ...
        \score {
          ...
          \addlyrics {
            ...
            \header {
              title = \titleFunc #'ref_desc_17 " Четвърти Божествен ден" "Četvărti Božestven den"
            }
          ...
          \score {
            ...
            \addlyrics {
              ...
              \header {
                title = \titleFunc #'ref_desc_17 "Пети Божествен ден" "Peti Božestven den"
              }
            ...
            \score {
              ...
              \header {
                title = \titleFunc #'ref_desc_17 " Шести Божествен ден" "Šesti Božestven den"
              }
            ...
            \score {
              ...
              \addlyrics {
                ...
                \header {
                  title = \titleFunc #'ref_desc_17 " Седми Божествен ден" "Sedmi Božestven den"
                }
