...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    ...
    \justify {
      ...
      музикалния и словесен текст, разполагайки го логично в съответни
      размери, съобразени с хармоничния строеж на мелодията. Според
      нас, подборът на тоналностите при Учителя не е случаен. Той изра-
      зява връзката между цветове, тонове, планети и числа, и всеки опит
      ...
      един голям екип, в който участваха Георги Стратев, Йоанна
