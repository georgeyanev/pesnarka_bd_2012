...
\bookpart {
  ...
  \score {
    ...
    \new Voice \absolute  {
      ...
      a4 d'4 e' f' a4 a d'2 e'4  g'4 f' e' d'

      a4 a d'2 \break e'4 g'4 f' e' d' d'2  f'4 e' d' a bes bes  bes2 a \fermata  \break

      \bar ".|:" a'4 gis'8 a' bes'4 a'8. gis'16 a'2 g'8 f'

      e'4 g' f' f' e' d'2 \break   e'4 g'8 f' e'4 d' f'4 e' d'2 \bar ":|.|:"

      d''8. cis''16 d''8 a' bes'4 a'  \break g'8 f' e' f' g'4 a'8 a'

      d'8 e' f'4 e'8 d' e' f' d'2 \bar ":|.|:"  \break

      a4 a'2 gis'4 a' bes'2 a'  g'4 ( a' ) f'2 e'4 f'  g'4 ( a' ) e'2.  \break

      e'4  f'4 g' a' e' g'2  f'2 e' d'2. \bar ":|."
    }
