...
\bookpart {
  ...
  \score {
    ...
    \new Voice \absolute {
      ...
      \tupletUp \tuplet 3/2 {r8 c'' c''8 }  c''4~ ( \slashedGrace { \stemDown d''16[c''16] \stemNeutral }  b'8[c''] d''4)  c''4 ( b'8 [c''] a'4 ) g'2 \break

      g'4 -- a' -- g' ( f' ) e'2 g'8 g' f' e' f'2 g'4 a'4  \break

      b'8 b' c''4 a' g'2 c''8 e' g'4 f' f'2  a'8 a' a'4 g' g'2 \break
