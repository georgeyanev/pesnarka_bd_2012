...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    ...
    \justify {
      ...
      В окултната музика ние искаме да пеем не както хората пеят, а както Ангелите пеят. Чрез музиката можем да привлечем Ангелите – те ще се заинтересуват от нас. Ще им кажете: „Ние изучаваме вашата музика, искаме}}
      
        \markup \fontsize #+2.5 {
    \vspace #1.0 \override #'(baseline-skip . 2.7)
    \justify {
      да пеем като вас.“ Те ще кажат: „Много добре, ние ще ви дадем нашето присъствие и съдействие.“
