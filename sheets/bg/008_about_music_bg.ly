...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    ...
    \justify {
      ...
      Онази музика, която дава еднакво разположение на ума, на сърцето и на 
    }
  }
  ...
  тялото, е музика на Природата. Под думата Природа разбирам света на хармонията, мястото, откъдето е излязла музиката.
