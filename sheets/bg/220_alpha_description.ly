...
\bookpart {
  ...
  \markup \fontsize  #+2.5  {
    ...
    \column {
      ...
      \line {
        \justify {
          \concat {\with-link #'ref150 \bold "Българска идилия."} Песента е нотирана от магнетофонен запис на изпълнение на Петър Камбуров, редактирана от Георги Стратев, Йоана Стратева и Станка Желева. Учителя я предава лично на П. Камбуров през февруари 1920 г. на ул. „Опълченска“ № 66. Идилията описва копнежа на към вечното и великото в живота – тя иска да разбере вътрешния смисъл на живота, да постигне вечната правда, вечната Любов, която изпълва Битието. Тя съзира съществуването на един красив свят у себе си и иска да го направи реалност.
        }
      }
