...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    ...
    терпретации. Важно за всички хармонизации и оркестрации е    да запазят най-същественото в \italic {окултната} \italic {музика} – нейния дух. Тя нито може да служи за забава, нито сама по себе си е забава, а е израз на свещеното ни отношение към Създателя. Само тогава \italic {окултната} \italic {музика} ще разкрие богатствата си в пълнота. Важно за всички хармонизации и оркестрации е да запазят най-същественото в \italic {окултната} \italic {музика} – нейния дух. Тя нито може да служи за забава, нито сама по себе си е забава, а е израз на свещеното ни отношение към Създателя. Само тогава \italic {окултната} \italic {музика} ще разкрие богатствата си в пълнота.
       }
  }
