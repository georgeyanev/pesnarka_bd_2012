...
\bookpart {
  ...
  \markup \fontsize  #+3.5 { \fill-line \bold {"Предговор към настоящото издание"} }
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      стои принципът на абсолютната свобода като качество на \italic{окултната} \italic {музика.}
  ...
  \markup \override #'(line-width . 82.5) \fontsize  #+2.5 {
    ...
    \override #'(baseline-skip . 3.2) \column {
      \justify {
        пертоара присъстват също и популярни църковнославянски напеви. В този период честа практика е била многогласното хорово изпълнение на песните. Към този дял са добавени и песни от преки негови ученици, създадени след заминаването на Учителя.
      }
    }
  }

  \markup \override #'(line-width . 82.5) \fontsize  #+2.5 {
    \vspace #0.9  \override #'(baseline-skip . 3.2) \column {
      "    2."
    }
    \hspace #0.5
    \override #'(baseline-skip . 3.2) \column {
