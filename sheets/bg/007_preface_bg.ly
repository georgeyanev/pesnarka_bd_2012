...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    \vspace #1.6  \override #'(baseline-skip . 2.7)
    \justify {
      \hspace #0.6 От името на целия издателски екип пожелаваме приятни индивидуални и колективни занимания с тази неземна, космична музика! Бог е Любов.
    }
  }
