...
\bookpart {
  ...
  \markup \fontsize #+2.5 {
    \override #'(baseline-skip . 2.7)
    \justify {
      на някои песни, минимално осъвременяване на лирическия им текст спрямо лексикалните и синтактичните норми на съвременния български език, както и корекции в нотния правопис. При някои от песните с несиметрична структура и подчертано свободен ритъм бе въведена безмензурна нотация, кореспондираща с концепцията за \italic"несъизмеримите" \italic"величини" в \italic"окултната" \italic"музика." В редакционния процес бяха използвани всички налични първоизточници, което доведе до отстраняване на редица грешки и неадекватни редакторски решения, възникнали при предни редакции, засягащи части от песни или цели песни. Този процес беше подпомогнат и от експертното мнение на водещите братски музиканти, които подобриха обективността и автентичността на предлагания нотен текст с конкретни забележки. За пръв път бяха въведени редакторски бележки, документиращи и аргументиращи направените редакционни промени в нотния текст. Чрез широкото използване на \italic {ossia} бяха обозначени вариантите на песните, съответстващи на специфичните бележки на преките ученици музиканти на Учителя, които бяха отбелязани и в обяснителните бележки. По същия начин бе постъпено и с вариантите на лирическите текстове. Всички обяснителни бележки бяха преработени и допълнени. Отстранени бяха и някои фактологически грешки. Смесването на автентични мелодии със съвременни текстове като практика на досегашните издания бе избегнато като автентичните мелодии бяха запазени в своя оригинал в основната част на сборника, а съвременното творчество  поместено в допълнение в края на сборника. Темповите означения в песните трябва да бъдат разгледани като условни, защото те не са оригинално зададени от Учителя, а представят виждането на съвременните музиканти за тях.    
    }
  }
    ...
    \justify {
       ...
       възможни интерпретации. Важно за всички хармонизации и оркестрации е    да запазят най-същественото в \italic {окултната} \italic {музика} – нейния дух. Тя нито може да служи за забава, нито сама по себе си е забава, а е израз на свещеното ни отношение към Създателя. Само тогава \italic {окултната} \italic {музика} ще разкрие богатствата си в пълнота. Важно за всички хармонизации и оркестрации е да запазят най-същественото в \italic {окултната} \italic {музика} – нейния дух. Тя нито може да служи за забава, нито сама по себе си е забава, а е израз на свещеното ни отношение към Създателя. Само тогава \italic {окултната} \italic {музика} ще разкрие богатствата си в пълнота.
       }
  }
