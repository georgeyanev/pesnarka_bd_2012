...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      Тодорова, Лилиана-Цветана Табакова, Матей Калу- дов, Христо Дързев и други. За съжаление
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      твърде набързо поради неблагопри- ятните политически условия.
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      едни са дораз- вити, а други, според мен, са опростени за удобство
      ...
      в други случаи рит- мичните фигури са намерили по-естествено
      звучене. В това отноше- ние съществуват много примери, но
