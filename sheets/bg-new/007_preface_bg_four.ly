...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    \override #'(baseline-skip . 3.4)
    \justify {
      дателя. Само тогава \italic {окултната} \italic {музика} ще разкрие богатствата си в пълнота.
    }
  }
