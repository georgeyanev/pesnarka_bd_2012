...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
       ...
       на никакво нотиране. Звучали са музикално-природни картини, медитативни мелодии, микро-интервали, непрекъсната смяна на тоналности, ритми, състояния, настроения, подредени в една композиция, в чиято основа стои принципът на абсолютната свобода като качество на \italic{окултната} \italic {музика.}
  ...
  \markup \abs-fontsize #11 {
   ...
   \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      Целта на настоящото издание е да представи музикалните композиции на Учителя в един професионален вид. То е адресирано както към професионалните музиканти, така и към любителите, т.е. към всички онези хора с усет към  духовното, които желаят да се докоснат до красотата и необикновеността на тази музика. Голямото разнообразие на тоналности, от най-простите до онези с шест знака, 
    }
  }
    ...
    \justify {
      ...
      \hspace #1.5 От името на целия издателски екип пожелаваме приятни индивидуални и колективни занимания с тази неземна, космична музика! Тя повдига, радва душите ни, утешава, лекува и възкресява. Бог е Любов.
    }
  }
