...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      От дистанцията на времето все по-належаща е нуждата от едно адекватно представяне на вокалните и инструменталните компо- зиции на Учителя Петър Дънов. Като такова то следва да е съобразено както с професионалните музикални изисквания, така и с принци- пите и законите, които той поставя като тяхна теоретична основа. Настоящото издание отговаря на тази потребност и изхождайки от горните изисквания, предлага някои нови редакционни решения на музикалните въпроси, които тази музика поставя.
