...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      \hspace #1.5
      Музиката е един от начините природата да оживее във вас – камъ- ните ще оживеят, дърветата, изворите, всичко наоколо ще оживее.
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      \hspace #1.5
      Окултната музика е музика на образи и картини. Когато пеем, вина- ги трябва да се произведе картина – да изпъкват не обикновени мъртви картини, а живи.
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      \hspace #1.5
      И тъй, когато дойдем до несъизмеримите и съизмеримите неща, трябва да знаем, че те са две идеи в живота, които напълно се разли- чават. Мъдростта, Истината, всички добродетели са несъизмерими величини.
    }
  }
  ...
  \markup \abs-fontsize #11 {
    ...
    \vspace #0.9  \override #'(baseline-skip . 3.4)
    \justify {
      \hspace #1.5  Как ще преведете сега тази мелодия [Имаше человек]? Тя спада към несъизмеримите величини. Ако тя би се изпяла другояче, на тактове,}}
