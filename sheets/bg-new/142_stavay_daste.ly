...
\bookpart {
  ...
  \score {
    ...
    \new Voice \absolute {
      ...
      \time 8/16 \tempo "Allegretto" g8 [(as16 )] bes8 (ces'8. ) | \break d'8. es'8 (es'8.) |
      ...
      f'4 es'8. d'16  es'2 |
      \time 3/4 d'8. ces'16 ces'4 bes8. [(as16) ] | as2 r4 | \bar "||"
      \time 8/16 \tempo "Allegretto" g8 [(as16 )] bes8 (ces'8. ) | d'8. es'8 (es'8.) |  f'8 es'16 d'8 ces'8. | d'8 ces'16 d'8 ces'8. | \break
      bes8 [(as16)] bes8 (bes8.)

      ces'8. ( ~ ces'8 bes8. ) |
      as8. ~ as8 ~ as8. | % 24
      g8 as16 bes8 ces'8. | \break % 25
      d'8. es'8 ~ es'8.  |
      f'8 (es'16) d'8 ( ces'8.) | % 27
      d'8 (ces'16) d'8 ces'8. | % 28
      bes8 [( as16 )] bes8 ~ bes8. | \break
    ...
    \header {
      title = \titleFunc #'ref_desc_20 "Ставай, дъще!" "Stavaj, dăšte!"
    }
