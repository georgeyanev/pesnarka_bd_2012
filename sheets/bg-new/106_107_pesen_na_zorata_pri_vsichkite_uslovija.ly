...
\bookpart {
  ...
  \score {
    ...
    \header {
      title = \titleFunc #'ref_desc_17 "Песен на зората" "Pesen na zorata"
    }
  ...
  \score {
    ...
    \new Voice \relative c' {
      ...
      \tempo "                  Fine" c2  \bar "!!" a8 ( f8 ) \autoBeamOff \repeat volta 2 {
    ...
    \header {
      title = \titleFunc #'ref_desc_18 "При всичките условия" "Pri vsičkite uslovija"
    }
