...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      Музиката, пеенето имат смисъл само тогава, когато служат за обла- городяването на човека. Чрез музиката можете да създадете в себе си характер.
    }
  }
  \markup \abs-fontsize #11 {
    \vspace #0.9  \override #'(baseline-skip . 3.4)
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      Певецът и музикантът трябва да имат добре развито ухо, за да схва- щат и предават правилно тоновете, които идат от възвишения свят.
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
      ...
      Немислимо е да станеш гениален без музика. Геният е човек, попад- нал в музикалното течение на природата.
    }
  }
