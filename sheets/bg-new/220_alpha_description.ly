...
\bookpart {
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      ...
      \line {
        \justify {
          \concat {\with-link #'ref150 \bold "Българска идилия."} Песента е нотирана от магнетофонен запис на изпълнение на Петър Камбуров, редактирана от Георги Стратев, Иоана Стратева и Станка Желева. Учителя я предава лично на П. Камбуров през февруари 1920 г. на ул. „Опълченска“ № 66. Идилията описва копнежа на към вечното и великото в живота – тя иска да разбере вът-
        }
      }
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      ...
      \line {
        \justify {
          решния смисъл на живота, да постигне вечната правда, вечната Любов, която изпълва Битието. Тя съзира съществуването на един красив свят у себе си и иска да го направи реалност.
        }
      }
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      \line {
        \justify {
          на стария – той вече няма да греши, няма и да умира. На музикален език –  той ще пее правилно тоновете на гамата до тона \italic"ла," който също ще взима добре – \italic"ла" отговаря на Шестата раса. Остава неизпят само тонът \italic"си," узрелият плод, който символизира Седмата раса. Седемте Божествени дни от Битието отговарят на седемте тона на гамата. Така \italic"Първият" \italic"Божествен" \italic"ден" започва с тона \italic"до." Това значи, че светлите сили, които са започнали създаването на новия свят, ще преустроят материята на стария живот в една по-висока гама и ще внесат в нея елемент на безсмъртие. По аналогия в Новия Адам ще се образуват нови кръвни телца, пропити с качествата на бъдещия живот. \italic"Вторият" \italic"Божествен" \italic"ден," който започва с тона \italic"ре," ще донесе преустройство в нервната система, костите и волята. Така всеки Божествен ден ще внесе нещо ново в устройството на Космоса и човека. И всеки човек поотделно ще изживее своето \italic"Ново Битие." Песента завършва с магическите слова на Мировия дух \italic"Аум" и на Мировата душа – \italic"Аумен" \italic"(Тълкуване" \italic"по" \italic"идеи," \italic"дадени" \italic"от" \italic"Учителя.)"
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      ...
      \line {
        \justify {
          \concat {\with-link #'ref039 \bold "Сърдечен зов."} Музика от Атанас Д. Ковачев, композирана на фронта при Добро поле през Първата световна война, 1917 г., по мотив от Учителя, текст от Илия Зурков. \italic"Ред. бел.:" Тук са коригирани несъответ-
        }
      }
    }
  }
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      \line {
        \justify {
          ствията между акцентите в ритъма на думите и тези в ритъма на мелодията. Това наложи минимална промяна в словореда на някои места в интерес на спазването на естественото съответствие на акцентите.
        }
      }
      \vspace #0.5
      \line {
      ...
      \line {
        \justify {
          \concat {\with-link #'ref070 \bold "Фир-фюр-фен – Благославяй."} Дадена на 21 август 1922 г., на събора във Велико Търново в беседата „Музика, работа и пост“. Тази песен е за тониране и лекуване – регулира теченията на силите в човека, поставя го
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      \line {
        \justify {
          в хармония с Битието. Думите са на стар свещен език, не могат да се преведат буквално. Учителя им дава само приблизителен и частичен превод: Без страх и без тъмнина! \italic "Фир-фюр" – това, което ръководи човека;
