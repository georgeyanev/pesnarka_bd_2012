...
\bookpart {
  ...
  \markup \abs-fontsize #11
  {
    ...
    \column {
      ...
      \line {
        \justify {
          несъответствия между акцентите в ритъма на думите и тези в ритъма на мелодията. Това наложи минимална промяна в словореда на някои места в интерес на спазването на естественото съответствие на акцентите.
        }
      }
    }
  }
