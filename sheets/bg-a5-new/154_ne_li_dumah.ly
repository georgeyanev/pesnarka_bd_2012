...
\bookpart {
  ...
  \markup \abs-fontsize #11 {
    ...
    \column {
      ...
      \line {   "        "  а на болни вечер из селото нека тя вода разнася.}

      \line {   "        " Наша Донка, мила мамо, по душа е блага, кротка, милостива,}

      \line {   "        " но сърце си трябва да научи, мамо, момците да не посмива.}
      ...
      \line {   "        " Кой я види как работи из селото, как на всекиму помага,}

      \line {   "        " да обикне и да прояви доброто като тая душа блага.}
    }
  } % markup
