...
\bookpart {
  ...
  \markup \fontsize  #+4.5 { \fill-line \bold {"Предговор към настоящото издание"} }
  ...
  \markup \abs-fontsize #11 {
    ...
    \justify {
         ...
         нение. Според спомените на присъстващите музиканти изсвирената композиция не е подлежала на никакво нотиране. Звучали са музикално-природни картини, медитативни мелодии, микро- интервали, непрекъсната смяна на тоналности, ритми,  състояния и настроения, подредени в една композиция, в чиято основа стои принципът на абсолютната свобода като качество на \italic{окултната} \italic {музика.}
   ...
   \markup \abs-fontsize #11 {
    ...
    \justify {
       ...
       Мария Тодорова, както и фототипно копие на нейния личен екземпляр, съдържащ нанесените от нея поправки на някои печатни грешки. Липсва обаче подлистникът с грешки към същото издание.
    ...
    \justify {
      \hspace #1.5
      Настоящото издание продължава линията на уважение и свещено отношение към музиката на Учителя на предишните поколения музиканти, запазвайки нейните автентичност и дух. То има три части:
    }
  }

  \markup  \override #'(line-width . 78) \abs-fontsize #11  {
  ...
  \markup \abs-fontsize #11 {
   ...
   \markup \abs-fontsize #11 {
  \vspace #1  \override #'(baseline-skip . 3.4)
    \justify {Tази редакторска линия наложи преосмисляне на структурната орга- низация  на някои песни, минимално осъвременяване на лирическия им текст спрямо лексикалните и синтактичните норми на съвременния български език, както и корекции в нотния правопис. При някои от песните с несиметрична структура и подчертано свободен ритъм бе въведена безмензурна нотация, кореспондираща с концепцията за \italic"несъизмеримите" \italic"величини" в \italic"окултната" \italic"музика." В редакционния процес бяха използвани всички налични първоизточници, което доведе до отстраняване на редица грешки и неадекватни редакторски решения, възникнали при предни редакции, засягащи части от песни или цели песни. Този процес беше подпомогнат и от експертното мнение на някои братски музиканти, които подобриха обективността и автентичността на предлагания нотен текст с конкретни забележки. За пръв път бяха въведени редакторски бележки, документиращи и аргументиращи направените редакционни промени в нотния текст. Чрез широкото използване на \italic {ossia} бяха обозначени вариантите на песните, съот- ветстващи на специфичните бележки на преките ученици-музиканти на Учителя, които бяха отбелязани и в обяснителните бележки. По същия начин бе постъпено и с вариантите на лирическите текстове. Всички обяснителни бележки бяха преработени и допълнени. Отстранени бяха и някои фактологически грешки. Смесването на автентични мелодии със съвременни текстове като практика на досегашните издания бе избегнато, като автентичните мелодии бяха запазени в своя оригинал в основната част на сборника, а съвременното творчество поместено в допълнението в края на сборника. Темповите означения в песните трябва да бъдат разгледани като условни, защото те не са оригинално зададени от Учителя, а представят виждането на съвременните музи- канти за тях.
    ...
    \justify {
      ...
      Целта на настоящото издание е да представи музикалните композиции на Учителя в един професионален вид. То е адресирано както към про- } }
