...
\bookpart {
  ...
  \markup \abs-fontsize #12 {
    ...
    \justify {
      \hspace #1.5
      Настоящото издание продължава линията на уважение и свещено отношение към музиката на Учителя на предишните поколения музиканти, запазвайки нейните автентичност и дух. То е съставено от три части:
    }
  }
  
  
    \markup \override #'(line-width . 96.5) \abs-fontsize #12 {
    \override #'(baseline-skip . 3.2) \column {
      "    1."
    }
    \hspace #0.5
    \vspace #1.1  \override #'(baseline-skip . 3.2) \column {
      \justify { 
         \italic {Братски песни: } това са всички вокални композиции, създадени предимно преди 1922 г. Повечето от тях се раждат от съвместната работа между Учителя и неговите ученици. Поради това много от мелодиите или текстовете в тази част на сборника са създадени от ученици по негови идеи. Някои от мелодиите и текстовете са заимствани от песни на про-
    ...
    \hspace #0.5
      \override #'(baseline-skip . 3.2) \column {
      \justify { 
        тестантските евангелски църкви; в репертоара присъстват също и популярни църковнославянски напеви. В този период честа практика е била многогласното хорово изпълнение на песните. Към този дял са добавени и песни от преки негови ученици, създадени след заминаването на Учителя.
        
           }}}
           
            \markup \override #'(line-width . 96.5) \abs-fontsize #12 {
    \vspace #0.8  \override #'(baseline-skip . 3.2) \column {
      "    2."
    }
    \hspace #0.5
    \override #'(baseline-skip . 3.2) \column {
  ...
  \markup \abs-fontsize #12 {
    \vspace #1.1  \override #'(baseline-skip . 3.2)
    \justify {
   ...
   \markup \abs-fontsize #12 {
    ...
    \justify {
      \hspace #1.5
       ...
       Целта на настоящото издание е да представи музикалните композиции на Учителя в един професионален вид. То е адресирано както към професионалните музиканти, така и към люби-
