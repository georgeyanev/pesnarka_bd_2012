...
\bookpart {
  ...
  \markuplist \fontsize  #+2 {
    ...
    \table #'(0 0 0 -1) {
      ...
      \wordwrap {
        vor a, o, u, ă und Konsonanten dumpfer als im Deutschen, etwa wie im englischen
      ...
      \wordwrap {
        normalerweise wie deutsches \italic n in
      ...
      \wordwrap {
        stimmloses \italic s wie das deutsche \italic ß oder \italic ss in
        \concat{„da\bold{ss} “}
      }
      ...
      \wordwrap {
        wie deutsches \italic { unbetontes, stark dumpfes e} in
      ...
      \wordwrap {
        sehr selten, wird ausgesprochen wie das kurze, unbetonte \italic {i} (s.o.);
        kommt nur zusammen mit o in der Wortmitte vor
      }
      ю [ju] ju \override #`(baseline-skip . ,blineskip250)
      \wordwrap {
        wie deutsches \italic ju in
