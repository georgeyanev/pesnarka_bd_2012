...
\bookpart {
  ...
  \score {
    ...
    \new Voice \absolute {
      ...
      \tempoFunc "Lento" 4 "56"
      \autoBeamOff
      a'4. b'8 |  c''8 b'8 a'8 gis'8 | a'4 b'4 | e'2 |  f'4 e'8 d'8  |


      c'4. b8 | c'4 d'4 | \break e'2 | b4. d'8 | c'4 b4 | e'8 ( [d'8] ) c'8 b8  |


      a4 gis4 | a2  \bar ".|:-|"
      | \tempoFunc "Allegretto" 4 "92" | e'4 d'8. f'16 | e'4. d'8 | \break  c'8. b16 c'8. d'16 |

      e'2 | e'4 b8. d'16 | c'2 |  e'4 d'8. f'16 | \break e'4. a'8 | d'4. g'8  |

      f'4 e'8 d'8 |   c'4. b8 |   \key a \minor a4. e'8 |  a4. d'8 | \break c'4. b8 |
  ...
  \include "../../lyrics/de/117_tam_daleche_lyrics_de.ly"
