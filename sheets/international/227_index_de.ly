...
\bookpart {
  ...
  \column  \abs-fontsize #10 {
    \with-link #'ref137 \fill-with-pattern #1 #RIGHT . "А бре, синко –  A bre, sinko" \page-ref #'ref137 "000" "?"
      ...
      \with-link #'ref100 \fill-with-pattern #1 #RIGHT . "Всичко в живота е постижимо – Vsičko v života e postižim" \page-ref #'ref100 "000" "?"
      \with-link #'ref200 \fill-with-pattern #1 #RIGHT . "Вътрешният глас на Бога – Vătrešnijat glas na Bog" \page-ref #'ref200 "000" "?"
  ...
  \column \abs-fontsize #10 {
    ...
    \with-link #'ref118_1 \fill-with-pattern #1 #RIGHT . "Денят иде – Denjat ide" \page-ref #'ref118_1 "000" "?"
      ...
      \with-link #'ref253 \fill-with-pattern #1 #RIGHT . "Добрата молитва – Dobrata molitva" \page-ref #'ref253 "000" "?"
      ...
      \with-link #'ref254 \fill-with-pattern #1 #RIGHT . "Марш на светлите сили II – Marš na svetlite sili II" \page-ref #'ref254 "000" "?"
  }
  ...
  \column \abs-fontsize #10 {
    \with-link #'ref080 \fill-with-pattern #1 #RIGHT . "Махар Бену Аба – Mahar Benu Aba" \page-ref #'ref080 "000" "?"
      ...
      \with-link #'ref175_2 \fill-with-pattern #1 #RIGHT . "Ме-хейн II – Me-hejn II" \page-ref #'ref175_2_2 "000" "?"
      ...
      \with-link #'ref251_1 \fill-with-pattern #1 #RIGHT . "Мелодия 2 – В радостта – Melodija 2 – V radostta" \page-ref #'ref251_1 "000" "?"
      ...
      \with-link #'ref251_2 \fill-with-pattern #1 #RIGHT . "Мелодия 4 – Озарение – Melodija 4 – Ozarenie " \page-ref #'ref251_2 "000" "?"
      ...
      \with-link #'ref252 \fill-with-pattern #1 #RIGHT . "Молитва (Господи, Ти Си) – Molitva (Gospodi, Ti Si)" \page-ref #'ref252 "000" "?"
