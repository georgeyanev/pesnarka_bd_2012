...
\bookpart {
  ...
  \score {
    ...
    \new Voice \absolute {
      ...
      a4^\mp^\< | d'2 e'8. \! e'16 | f'4^\> ( d'4 cis'8[d'8] |  e'4 ) a4 \! r4 |

      \time 4/4  a'2^ \p c''4 bes'4 | a'4 ( g'4 ) a'2 ( | \break a'4 ) r4 r4 a4^\mf ^\< | f'2 e'4 \! d'8 ^\markup { \huge \italic "   sosten."} [( e'32 d'32 cis'32 d'32 )] |
