...
\bookpart {
  ...
  \markup \override #'(line-width . 90.5) \abs-fontsize #10  {
    ...
    \override #'(baseline-skip . 3.4) \column {
      \justify {
        Brüderliche Lieder: Dies sind alle Vokalkompositionen, die vorwiegend vor 1922 geschaffen wurden. Die meisten von ihnen sind aus der Zusammenarbeit zwischen Danov und seinen Schülern entstanden. Deshalb wurden viele der Melodien oder Texte in diesem Teil des Sammelbandes von ihnen nach seinen Ideen geschaffen. Manche Melodien und Texte wurden Liedern der protestantischen Kirchen entlehnt; ebenso gab es im Repertoire kirchenslawische Gesänge. In dieser Zeit war der mehrstimmige Gesang der Lieder gängige Praxis. Zu diesem Teil wurden einige Lieder seiner direkten Schüler hinzugefügt, die nach 1944 von ihnen komponiert wurden.
