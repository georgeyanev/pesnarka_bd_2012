...
\bookpart {
  ...
  \markup  \abs-fontsize #11  {
    \override #'(baseline-skip . 3.8)
    \justify {
     \italic"sikformen" nur schwer einer Notation unterliegen, kann mit dem folgenden Beispiel veranschaulicht werden: Als die Schüler Danov darum baten, eine bestimme Musikübung zu wiederholen, damit sie sie genau notieren können, spielte er sie jedes Mal etwas anders. Das liegt laut Danov an den \italic"musikalischen Urbildern," die, wenn sie den Bereich der physischen Welt erreichen, gewissen Veränderungen unterliegen, d. h. sie finden jedes Mal einen anderen konkreten Ausdruck. Ihre Fixierung und Begrenzung in der Notation transformiert die lebendige Musiksubstanz, indem sie sie in einer vollendeten, kommensurablen Form verwandelt, in der sich das schöpferische Prinzip und das Prinzip der absoluten Freiheit nicht manifestieren können. Sie hören auf, begeistet zu sein, weil die lebendige Verbindung mit dem Göttlichen unterbrochen ist. Ein Beispiel hierfür ist das Lied „Kaži mi Ti Istinata – Sage mir die Wahrheit“, das in drei Varianten überliefert wurde. Es ist ein Vorbild für eine \italic"inkommensurable Übung," die Danov bewusst unvollendet lässt.
    }
  }
  ...
  \markup \override #'(line-width . 100) \abs-fontsize #11  {
    \override #'(baseline-skip . 3.8) \vspace #1.4 \column {
      "    1."
    }
    \hspace #0.1
