...
\bookpart {
  ...
  \markup  \abs-fontsize #10  {
    ...
    \justify {
      ...
      Der vorliegende Sammelband setzt die Linie der Achtung und der heiligen Bezugs zu Petar Danovs Musik der früheren Generationen Musiker fort, indem er ihre Authentizität und ihren Geist bewahrt. Der Sammelband besteht aus drei Teilen:
    ...
    \override #'(baseline-skip . 3.4) \column {
      \justify {
        Brüderliche Lieder: Dies sind alle Vokalkompositionen, die vorwiegend vor 1922 geschaffen wurden. Die meisten von ihnen sind aus der Zusammenarbeit zwischen Petar Danov und seinen Schülern entstanden. Deshalb wurden viele der Melodien oder Texte in diesem Teil des Sammelbandes von ihnen nach Ideen von Danov geschaffen. Manche Melodien und Texte wurden Liedern der protestantischen Kirchen entlehnt; ebenso gab es im Repertoire auch populäre kirchenslawische Gesänge. In dieser Zeit war der mehrstimmige Gesang der Lieder gängige Praxis. Zu diesem Teil wurden einige Lieder seiner direkten Schüler hinzugefügt, die nach Danovs Dahinscheiden von ihnen komponiert wurden.
  ...
  \markup \override #'(line-width . 89.5) \abs-fontsize #10   {
    ...
    \override #'(baseline-skip . 3.4) \column {
      \justify {
        Lieder von Petar Danov: Das sind alle Kompositionen, die zwischen 1922 und 1944 in der okkulten Schule der Weißen Bruderschaft geschaffen wurden. Autor der Melodie und des Textes hier ist Petar Danov. Viele der Kompositionen sind in einer heiligen Sprache, die er Watanisch nannte.
    ...
    \override #'(baseline-skip . 3.4) \column {
      \justify {
        ...
        Nach 1944 veröffentlichte Lieder: Das sind alle Kompositionen, die nach Danovs Dahinscheiden 1944 publiziert wurden. Dieser Teil enthält neben vielen Vokalkompositionen auch viele rein instrumentelle Kompositionen und Melodien. Besondere Beachtung verdient hier der Zyklus von sieben Liedern
  ...
  \markup \override #'(line-width . 89.5) \abs-fontsize #10   {
    ...
    \override #'(baseline-skip . 3.4) \column {
      \justify {
        ...
        „Die neue Genesis“ – ein neuer Zyklus in der okkulten Musik, der ihre kosmischen, kosmologischen und kosmogonischen Aspekte darstellt. Dieser Liederzyklus wurde dank der Opernsängerin Liljana Tabakova überliefert, die an der École Normale de Musique de Paris Musik studierte. Danov arbeitete musikalisch speziell mit ihr. In ihrem Beisein erschuf er einige seiner sakralen Kompositionen.
 ...
 \markup  \abs-fontsize #10  {
  ...
  \markup  \abs-fontsize #10  {
    ...
    \justify {
      ...
      Das Ziel des vorliegenden Sammelbandes ist es, die Musikkompositionen des spirituellen Lehrers Petar Danov in einer professionellen Weise vorzustellen. Er ist sowohl an den professionellen Musikern als auch an den Laien gerichtet, d. h. an alle, die von der Schönheit und der Einzigartigkeit dieser Musik berührt werden möchten. Die große Vielfalt an Tonarten, von den einfacheren bis zu diesen mit
    }
  }
