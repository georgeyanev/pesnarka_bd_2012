...
\bookpart {
  ...
  \markup  \abs-fontsize #11  {
    \vspace #0.9 \override #'(baseline-skip . 3.8)
    \justify {
      \italic"okkulte Musik," welche die in ihr liegenden Schlüssel und Codes entdecken und erforschen würde. Bedingung der Möglichkeit des wahren Verständnisses und der adäquaten Inter- pretation der  \italic"okkulten Musik"  bleibt aber die genaue Kenntnis der Vorträge sowie der Prinzipien,
