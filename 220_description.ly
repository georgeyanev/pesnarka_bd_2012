...
\bookpart {
  ...
  \markup \fontsize #+2 \override #'(line-width . 66.5)
  {
    ...
    \column {
      ...
      \line {
        \justify {
          \fontsize  #+0.8 \smallCaps { \fill-line { \bold"Brüderliche Lieder"} }
        }
      }
      \vspace #0.5
      \line {
        \justify {
          \concat {"1" . \smallCaps "  Зората на Новия живот – Zorata na Novija život."}
      ...
      \line {
        \justify {
          \concat {"2" . \smallCaps " Излязъл е сеяч – Izljazăl e sejač."}
      ...
      \line {
        \justify {
          \concat {"3" . \smallCaps  "  Братство единство – Bratstvo, edinstvo."}
