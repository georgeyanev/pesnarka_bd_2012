...
\bookpart {
  ...
  \markup \fontsize  #+2.5  {   \hspace #3  \vspace #1.5  Übersetzung aus dem Bulgarischen:  Mariya Kireva, Klaudia Wittich-Harz}
  \markup \fontsize  #+2.5  {   \hspace #3  \vspace #0.5  Layout:  George Yanev}
