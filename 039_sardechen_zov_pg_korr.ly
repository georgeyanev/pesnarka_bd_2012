...
\bookpart {
  ...
  \score{
    ...
    \addlyrics {
      ...
      рю пре -- бла -- гий на свет -- ли -- те ду -- ши, Ти в~цар -- ство --
      то си ни при -- е -- ми! __ Ца -- ми!
    ...
    \addlyrics {
      ...
      ryu pre -- bla -- giy na svet -- li -- te du -- shi, Ti v~tsar -- stvo --
      to si ni pri -- e -- mi! __ Tsa -- mi!
